        ...
        <Stack gap={2}>
            {apps.map((app) => (
                <Card key={app.name} size="lg" variant="outlined">
                    ...
                    <CardActions>
                        <Button variant="soft" color="neutral" href={app.__metaData.devUrl} endDecorator={<KeyboardArrowRight />}>
...
export const DependencyList = ({dependencies, children}: React.PropsWithChildren<{ dependencies: Record<string,string>}>) => (
    <ListItem nested>
